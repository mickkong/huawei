...
<html>
  <head>
	...
	<title>退换货申请-个人中心-华为商城</title>
	<style type="text/css" media="screen">
		#myOrder-cate {
			margin-bottom: 25px;
		}
		.myOrder-record .col-price1 {
		    width: 237px;
		}
		.myOrder-record .col-quty1 {
		    width: 180px;
		}
		.myOrder-record .col-pay1 {
		    width: 113px;
		}
		.myOrder-record .col-operate1 {
		    width: 170px;
		}
	</style>
					...
					<ul>
						<li>
                            ...
                            <ol>
                            	...
                            	<li id="li-exchange"  class="current">
						...
						<li>
                            ...
                            <ol>
                            	<li id="li-prdRemark">
                                    <a href="商品评价.html" title=""><span>商品评论</span></a>
                            	</li>
                            	<li id="li-msg">
...
<!-- 右边 -->
		<div class="fr u-4-5">
			...
			<div class="myOrder-cate" id="myOrder-cate">
				<ul>
					<li class="current"><a href="">最近六个月</a></li>
					<li><a href="">六个月以前</a></li>
				</ul>
			</div>
			<div class="myOrder-record" id="myOrders-list-content">
				<div class="list-group-title">
					<table border="0" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th class="col-pro1">退换货编码</th>
								<th class="col-price1">订单号</th>
								<th class="col-quty1">申请时间</th>
								<th class="col-pay1">状态</th>
								<th class="col-operate1">操作</th>
							</tr>
						</thead>
					</table>
				</div>
