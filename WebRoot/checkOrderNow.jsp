  ...
  <head>
	...
	<%
		String productCode=request.getParameter("productCode");
	   	...
	   	//保留两位小数
	   	float total=Float.parseFloat(String.format("%.2f", num*money).toString());  	
	    ...
	    if(c=="---请选择收货地址---"){
		 ...
		 if ($("#checkbox").get(0).checked) {
		    if((<%=point/100%>)>(<%=total%>*0.8)){
		        ...
		        location.href='order?type=orderDetail&money='+var1+'&allmoney='+var2+'&userpoint='+userpoint+'&num='+num+'&productCode='+productCode+'&address='+c+'&addrId='+b;  
			}else{
	...
	<div class="head">
		...
		<div class="header_left">
			<ul>
				...
				<!-- 头部右边 -->
	<div class="header2_right2" style="width: 260px">
		<ul>
			<li class="qqwe" style="width: 150px">
			...
			<div class="model_div">
				...
				<div class="model_div1">
					<div class="model_div1_div">
						<span class="model_span">&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						<label class="model_label">手机号码&nbsp;：
						<input type="text"  class="model_div1_input1"></label>
		...
		<table>
			<tbody>
				<tr>
					...
					<ul>
						<li><a href="#" ><%=request.getParameter("uname") %></a></li>
						<li><i>[配]</i><a href="#" >荣耀V9 保护壳</a></li>
						<li><i>[配]</i><a href="#" >天际通 7天全球上网流量</a></li>
					</ul>
					</td>
					<td style="width:182px;"><%=request.getParameter("money") %></td>
					<td style="width:82px;"><%=request.getParameter("num") %></td>
					<td>￥<%=total%></td>
				</tr>
			</tbody>
		</table>
...
<script type="text/javascript">
		...
		btn.onclick = function(e){
			...
			var mo = document.getElementById(this.getAttribute("data-id"));
			tDIV.style.display = "block";
